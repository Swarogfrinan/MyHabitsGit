...
public final class Habit: Codable {
   ...
   public var emoji: String
    ...
    public init(name: String, emoji: String, date: Date, trackDates: [Date] = [], streak: Int, color: UIColor) {
        self.name = name
        self.emoji = emoji
        self.date = date
...
public final class HabitsStore {
    ...
    public func save() {
        do {
            ...
            print("Ошибка кодирования привычек для сохранения по  ключу habits", error)
        }
    }
    ...
    private init() {
        ...
        do {
            ...
            print("Ошибка декодирования сохранённых привычек, нужна StartDate", error)
        }
    }
}
